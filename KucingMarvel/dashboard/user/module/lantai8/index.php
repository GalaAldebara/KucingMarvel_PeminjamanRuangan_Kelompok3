 ...
 <div class="container-fluid">
                     ...
                     <div class="row no-gutters align-items-center">
                         <div class="col mr-2">
                             <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                 Permintaan Diterima</div>
                             <div class="h5 mb-0 font-weight-bold text-gray-800">
                                 <?php
                                    $ruang->jmlhRuangDiterima();
                                    ?>
                             </div>
                         </div>
                     </div>
         ...
         <div class="col-xl-3 col-md-6 mb-4" style="cursor: default;">
             <div class="card border-left-danger shadow h-100 py-2">
                 <div class="card-body">
                     <div class="row no-gutters align-items-center">
                         <div class="col mr-2">
                             <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Permintaan Ditolak</div>
                             <div class="h5 mb-0 font-weight-bold text-gray-800">
                                 <?php
                                    $ruang->jmlhPermintaanDitolak();
                                    ?>
                             </div>
                         </div>
                     </div>
     ...
     <div class="background">
         ...
         <div class="row m-2">
             ...
             <input type="date" name="tanggal" id="date2" class="custom-date-input">
