...
<head>
    ...
    <style>
        ...
        body::before {
            ...
            /* Untuk dukungan browser WebKit (Chrome, Safari) */
            backdrop-filter: blur(8px);
            z-index: -2;
            /* Memastikan elemen ini berada di belakang konten lainnya */
        }
    </style>
                                ...
                                <div class="p-5">
                                    ...
                                    <form method="post" class="user" action="cek_login.php">
                                        <div class="form-group">
                                            <input type="text" name="nim" class="form-control form-control-user" id="exampleInputText" aria-describedby="textHelp" placeholder="NIM/NIP" required>
                                        </div>
                                        <div class="form-group">
